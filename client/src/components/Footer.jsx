    ...
    <div className='text-gray-500/80 bg-[#F6F9FC] pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    ...
                    <p className='text-sm'>
                        QuickStay is your gateway to exclusive and luxurious accommodations around the world. Discover unique stays, personalized service, and unforgettable experiences tailored just for you.
                    </p>
                    <div className='flex items-center gap-3 mt-4'>
                        {/* Instagram */}
                       <img src={assets.instagramIcon} alt="insatgram-icon"  className='w-6'/>
                        {/* Facebook */}
