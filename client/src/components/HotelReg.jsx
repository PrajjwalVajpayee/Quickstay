    ...
    <div className='fixed top-0 left-0 bottom-0 right-0 z-100 flex items-center justify-center bg-black/70'>
      <form className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
        ...
        <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
            ...
            <p className='text-2xl font-medium mt-6'>Register Your Hotel</p>
            ...
            <button className='bg-indigo-500 hover:bg-indigo-600 transiton-all text-white mr-auto px-6 py-2 rounded cursor-pointer mt-6 '>Register</button>
        </div>
      </form>
    </div>
  )
